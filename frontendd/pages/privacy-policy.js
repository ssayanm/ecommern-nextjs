...
const PrivacyPolicy = () => {
  return (
    <section className="py-20 lg:py-32 bg-brown-50">
      <Meta
        title="Privacy Policy Pleasant Smith"
      ...
      >
        <div className="flex flex-wrap justify-center ">
          <div className="w-full xl:w-8/12 px-4">
            <h2 className="text-4xl lg:text-5xl font-semibold text-pink-600 text-center">
              Privacy Policy
            </h2>
            <div className="w-24 h-1 bg-indigo-600 mx-auto mt-4" />

            <div className="flex flex-col sm:flex-row mt-10">
              <div className="sm:pl-8  border-gray-200 sm:border-t-0 border-t mt-4  sm:mt-0  sm:text-left">
                <div className="text-lg ptext mb-4 mt-4 md:mt-0">
                  ...
                  <ul>
                    ...
                    <li>
                      <p>
                        ...
                        &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in this Agreement) refers to Due
                        Coaching.
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p>
                        <strong>Country</strong> refers to: Connecticut, United
                        States
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p>
                        <strong>Website</strong> refers to Due Coaching,
                        accessible from{" "}
                        <a
                          href="https://www.duecoaching.com/"
                          rel="external nofollow noopener"
                          target="_blank"
                        >
                          https://www.duecoaching.com/
                        </a>
                      </p>
                    </li>
                    <li>
                  ...
                  <p>
                    ...
                    can refer to the &quot;Types of Data Collected&quot; section
                    of this Privacy Policy. We follow our standard Privacy
                    Policy for the disclosure of personal information collected
                  ...
                  <ul>
                    <li>
                      <p>
                        ...
                        <a
                          ...
                          class="__cf_email__"
                          data-cfemail="2b5b474e4a584a455f5846425f431a1c6b4c464a424705484446"
                        >
                          [email&#160;protected]
                        </a>
                      </p>
                    ...
                    <li>
                      <p>
                        ...
                        <a
                          href="https://www.duecoaching.com/contact-pleasant"
                          rel="external nofollow noopener"
                          target="_blank"
                        >
                          https://www.duecoaching.com/contact-pleasant
                        </a>
                      </p>
                    </li>
                  </ul>
